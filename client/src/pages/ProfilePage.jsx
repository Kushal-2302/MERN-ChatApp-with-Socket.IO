...
const ProfilePage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        render.readAsDataURL(seletectedImg);
        render.onload = async () => {
            ...
            rounded-lg'>
                <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
                    ...
                    cursor-pointer'>
                        ...
                        <img src={seletectedImg ? URL.createObjectURL(seletectedImg) : assets.avatar_icon } 
                        alt="" className={`w-12 h-12 ${seletectedImg && 'rounded-full'}`}/>
                ...
                <img className={`max-w-44 aspect-square rounded-full mx-10 max-sm:mt-10 ${seletectedImg && 'rounded-full'}`} src={authUser ?.profilePic || assets.logo_icon} alt="" />
            </div>
        </div>
    )
}
